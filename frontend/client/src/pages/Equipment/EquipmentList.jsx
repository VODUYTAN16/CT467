...
const EquimentList = () => {
  ...
  const fetch = async () => {
    ...
    try {
      ...
      setSnack({ open: true, severity: "error", message: t("dashboard.error_loading_equipment") || "Error loading equipment" });
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      setSnack({ open: true, severity: "success", message: t("message.deleted") || "Deleted" });
      fetch();
    } catch (err) {
      console.error(err);
